...
The current shipped identity is warm paper, ink charcoal, and ignite coral. Charcoal is reserved for navigation, footer, scanner surfaces, and ticket-like dark islands. Coral is the primary action color. Gold is a highlight for revenue, selling-fast, and payout moments; it is not the primary CTA.
...
- Coral (`#eb5a3c`) is the only primary action color: buy, reserve, create, send.
